...
const __ssr_vue_processAssetPath = (url) => "/public/html/admin/" + url;
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)}><h2> Admin - `);
...
const pages = /* @__PURE__ */ Object.assign({ "./pages/about.vue": () => Promise.resolve().then(() => require("./assets/about.20a0bec4.js")), "./pages/home.vue": () => Promise.resolve().then(() => require("./assets/home.413ebd8b.js")) });
...
async function render(url, manifest) {
  ...
  await router.push(
    url === router.options.history.base ? "/" : url.replace(router.options.history.base + "/", "/")
  );
