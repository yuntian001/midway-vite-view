...
const __ssr_vue_processAssetPath = (url) => "/public/html/index/" + url;
...
const PublicInstanceProxyHandlers = {
  ...
  set({ _: instance }, key, value) {
    ...
    if (setupState !== EMPTY_OBJ && hasOwn(setupState, key)) {
      ...
      process.env.NODE_ENV !== "production" && warn$1(`Attempting to mutate prop "${key}". Props are readonly.`, instance);
      return false;
    }
    if (key[0] === "$" && key.slice(1) in instance) {
      process.env.NODE_ENV !== "production" && warn$1(`Attempting to mutate public property "${key}". Properties starting with $ are reserved and readonly.`, instance);
      return false;
    } else {
...
const resolveTarget = (props, select) => {
  ...
  if (isString(targetSelector)) {
    if (!select) {
      ...
      if (!target) {
        process.env.NODE_ENV !== "production" && warn$1(`Failed to locate Teleport target with selector "${targetSelector}". Note the target element must exist before the component is mounted - i.e. the target cannot be rendered by the component itself, and ideally should be outside of the entire Vue component tree.`);
      }
      return target;
    }
  } else {
...
function useCssModule(name = "$style") {
  {
    ...
    if (!mod) {
      process.env.NODE_ENV !== "production" && warn$1(`Current instance does not have CSS module named "${name}".`);
      return EMPTY_OBJ;
    }
    return mod;
  }
...
function useCssVars(getter) {
  const instance = getCurrentInstance();
  if (!instance) {
    process.env.NODE_ENV !== "production" && warn$1(`useCssVars is called without current active component instance.`);
    return;
  }
...
function setSelected(el, value) {
  ...
  if (isMultiple && !isArray$1(value) && !isSet(value)) {
    process.env.NODE_ENV !== "production" && warn$1(`<select multiple v-model> expects an Array or Set value for its binding, but got ${Object.prototype.toString.call(value).slice(8, -1)}.`);
    return;
  }
...
initDirectivesForSSR();
const _imports_0 = "" + __ssr_vue_processAssetPath("assets/vite.4a748afd.svg");
const _imports_1 = "" + __ssr_vue_processAssetPath("assets/vue.5532db34.svg");
...
(function(exports2) {
  ...
  function mergeReactiveObjects(target, patchToApply) {
    ...
    for (const key in patchToApply) {
      ...
      if (isPlainObject2(targetValue) && isPlainObject2(subPatch) && target.hasOwnProperty(key) && !vueDemi.isRef(subPatch) && !vueDemi.isReactive(subPatch)) {
  ...
  function skipHydrate(obj) {
    return vueDemi.isVue2 ? skipHydrateMap.set(obj, 1) && obj : Object.defineProperty(obj, skipHydrateSymbol, {});
  }
  function shouldHydrate(obj) {
    return vueDemi.isVue2 ? !skipHydrateMap.has(obj) : !isPlainObject2(obj) || !obj.hasOwnProperty(skipHydrateSymbol);
  }
  ...
  function defineStore(idOrOptions, setup, setupOptions) {
    ...
    function useStore2(pinia, hot) {
      const currentInstance2 = vueDemi.getCurrentInstance();
      pinia = (process.env.NODE_ENV === "test" && activePinia && activePinia._testing ? null : pinia) || currentInstance2 && vueDemi.inject(piniaSymbol);
      if (pinia)
        setActivePinia(pinia);
      pinia = activePinia;
      if (!pinia._s.has(id)) {
...
const useStore = pinia_prod.defineStore("main", {
  state: () => {
    return {
      counter: 0
    };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><h1 data-v-33aeb8e8>${ssrInterpolate(__props.msg)}</h1><div class="card" data-v-33aeb8e8><button type="button" data-v-33aeb8e8>count is ${ssrInterpolate(unref(store).counter)}</button><p data-v-33aeb8e8> Edit <code data-v-33aeb8e8>components/HelloWorld.vue</code> to test HMR </p></div><p data-v-33aeb8e8> Check out <a href="https://vuejs.org/guide/quick-start.html#local" target="_blank" data-v-33aeb8e8>create-vue</a>, the official Vue + Vite starter </p><p data-v-33aeb8e8> Install <a href="https://github.com/johnsoncodehk/volar" target="_blank" data-v-33aeb8e8>Volar</a> in your IDE for a better DX </p><p class="read-the-docs" data-v-33aeb8e8>Click on the Vite and Vue logos to learn more</p><!--]-->`);
    };
  }
});
__ssr_vue_processAssetPath;
const HelloWorld_vue_vue_type_style_index_0_scoped_33aeb8e8_lang = "";
...
const HelloWorld = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-33aeb8e8"]]);
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_router_link = resolveComponent("router-link");
  _push(`<div${ssrRenderAttrs(_attrs)}><h2>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div data-v-295b27cc>`);
      _push(ssrRenderComponent(Header, null, null, _parent));
      _push(`<a href="https://vitejs.dev" target="_blank" data-v-295b27cc><img${ssrRenderAttr("src", _imports_0)} class="logo" alt="Vite logo" data-v-295b27cc></a><a href="https://vuejs.org/" target="_blank" data-v-295b27cc><img${ssrRenderAttr("src", _imports_1)} class="logo vue" alt="Vue logo" data-v-295b27cc></a></div>`);
...
__ssr_vue_processAssetPath;
const App_vue_vue_type_style_index_0_scoped_295b27cc_lang = "";
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-295b27cc"]]);
    ...
    return (failure ? Promise.resolve(failure) : navigate(toLocation, from)).catch((error) => isNavigationFailure(error) ? isNavigationFailure(error, 2) ? error : markAsReady(error) : triggerError(error, toLocation, from)).then((failure2) => {
      if (failure2) {
        if (isNavigationFailure(failure2, 2)) {
          if (process.env.NODE_ENV !== "production" && isSameRouteLocation(stringifyQuery$1, resolve2(failure2.to), toLocation) && redirectedFrom && (redirectedFrom._count = redirectedFrom._count ? redirectedFrom._count + 1 : 1) > 10) {
...
const pages = /* @__PURE__ */ Object.assign({ "./pages/about.vue": () => Promise.resolve().then(() => require("./assets/about.afac1c32.js")), "./pages/home.vue": () => Promise.resolve().then(() => require("./assets/home.fba71691.js")) });
...
const style = "";
function createApp() {
  const app = typeof window !== "undefined" && window.document.querySelector("html").dataset.ssr === "true" ? createSSRApp(App) : createApp$1(App);
...
var serializeJavascript = function serialize(obj, options) {
  ...
  function serializeFunc(fn) {
    ...
    var def2 = serializedFn.substr(0, argsStartsAt).trim().split(" ").filter(function(val) {
      return val.length > 0;
    });
    var nonReservedSymbols = def2.filter(function(val) {
      return RESERVED_SYMBOLS.indexOf(val) === -1;
    });
    if (nonReservedSymbols.length > 0) {
      return (def2.indexOf("async") > -1 ? "async " : "") + "function" + (def2.join("").indexOf("*") > -1 ? "*" : "") + serializedFn.substr(argsStartsAt);
    }
    return serializedFn;
  }
  ...
  if (options.isJSON && !options.space) {
    ...
    str = JSON.stringify(obj, options.isJSON ? null : replacer2, options.space);
  }
...
async function render(url, manifest) {
  ...
  const __pinia = serializeJavascript(pinia.state.value);
