...
import { B as Button } from "./button.64418995.js";
...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "../components/ImportType.vue":
      return __vitePreload(() => import("./ImportType.ab750c71.js"), true ? ["assets/ImportType.ab750c71.js","assets/vendor.0ab654a0.js"] : void 0);
    default:
...
const _withScopeId = (n) => (pushScopeId("data-v-ed8bce0e"), n = n(), popScopeId(), n);
...
const _sfc_main = {
  setup(__props) {
    ...
    const Foo = defineAsyncComponent(() => __vitePreload(() => import("./Foo.3f728383.js"), true ? ["assets/Foo.3f728383.js","assets/Foo.a8752494.css","assets/vendor.0ab654a0.js"] : void 0).then((mod) => mod.Foo));
    function load(file) {
...
var Home = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ed8bce0e"]]);
