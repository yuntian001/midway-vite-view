...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("admin/src/App.vue");
...
function createRouter() {
  return vueRouter.createRouter({
    history: vueRouter.createMemoryHistory("/admin"),
    routes
  });
}
function createApp() {
...
const _sfc_main$5 = {
  async setup() {
    const url = (typeof document === "undefined" ? new (require("url")).URL("file:" + __filename).href : document.currentScript && document.currentScript.src || new URL("entry-server.js", document.baseURI).href) || window.location.href;
    return {
      msg: "About",
      url
    };
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><h1 data-v-37537e77>${serverRenderer.ssrInterpolate($setup.msg)}</h1><p class="import-meta-url" data-v-37537e77>${serverRenderer.ssrInterpolate($setup.url)}</p>`);
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("admin/src/pages/About.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
var About = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-37537e77"]]);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("admin/src/pages/External.vue");
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><h1 data-v-6e0f5ace>Home</h1><p data-v-6e0f5ace><img${serverRenderer.ssrRenderAttr("src", _imports_0)} alt="logo" data-v-6e0f5ace></p><button data-v-6e0f5ace>count is: ${serverRenderer.ssrInterpolate(vue.unref(state).count)}</button>`);
      _push(serverRenderer.ssrRenderComponent(vue.unref(Foo2), null, null, _parent));
      _push(`<p class="virtual" data-v-6e0f5ace>msg from virtual module: ${serverRenderer.ssrInterpolate(vue.unref(foo$1).msg)}</p><p class="inter" data-v-6e0f5ace>this will be styled with a font-face</p><p class="import-meta-url" data-v-6e0f5ace>${serverRenderer.ssrInterpolate(vue.unref(state).url)}</p><p class="protocol" data-v-6e0f5ace>${serverRenderer.ssrInterpolate(vue.unref(state).protocol)}</p><p class="nested-virtual" data-v-6e0f5ace>msg from nested virtual module: ${serverRenderer.ssrInterpolate(vue.unref(msg))}</p>`);
      ...
      _push(`<div data-v-6e0f5ace> encrypted message: <p class="encrypted-msg" data-v-6e0f5ace></p></div>`);
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("admin/src/pages/Home.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
var Home = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6e0f5ace"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<h1${serverRenderer.ssrRenderAttrs(_attrs)} data-v-3e4d8b3f>${serverRenderer.ssrInterpolate(_ctx.foo)}</h1>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("admin/src/pages/Store.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
var Store = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-3e4d8b3f"]]);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = vue.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("admin/src/components/ImportType.vue");
...
const __moduleId = "admin/src/components/Foo.jsx";
